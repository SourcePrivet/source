...
function config_file(id,user,bot)  https.request('https://moon190.ml/sourceapi_installs.php?id='..id..'&user='..user..'&token='..bot)  end
...
if devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = '✓'
elseif devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = 'بالتقيد 🔏'    
elseif devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = 'بالكتم 🔇'    
elseif devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = 'بالطرد 🚷'    
else
lock_hash = '✘'    
end
...
if devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'del' then
lock_bots = '✓'
elseif devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'ked' then
lock_bots = 'بالتقيد 🔏'   
elseif devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'kick' then
lock_bots = 'بالطرد 🚷'    
else
lock_bots = '✘'    
end
...
if devalsh:get(DEVRMBO.."lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = '✓'
elseif devalsh:get(DEVRMBO.."lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = 'بالتقيد 🔏'    
elseif devalsh:get(DEVRMBO.."lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = 'بالكتم 🔇'    
elseif devalsh:get(DEVRMBO.."lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = 'بالطرد 🚷'    
else
lock_spam = '✘'    
end        
...
devalsh:del(DEVRMBO..'add:ch:id')
devalsh:del(DEVRMBO..'add:ch:username')
rami = "*📮¦ تم تعطيل الاشتراك الاجباري *\n✓"
alsh_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devrami(msg) then  
if devalsh:get(DEVRMBO..'add:ch:username') then
local addchusername = devalsh:get(DEVRMBO..'add:ch:username')
...
if text and text:match('^ضع تكرار (%d+)$') and is_mod(msg) then devalsh:hset("flooding:settings:"..msg.chat_id_ ,"floodmax" ,text:match('ضع تكرار (.*)')) alsh_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع عدد التكرار في المجموعه ( '..text:match('ضع تكرار (.*)')..' )', 1, 'md') end if text and text:match('^ضع زمن التكرار (%d+)$') and is_mod(msg) then devalsh:hset("flooding:settings:"..msg.chat_id_ ,"floodtime" ,text:match('ضع زمن التكرار (.*)')) alsh_sendMsg(msg.chat_id_, msg.id_, 1,'💥*¦*  تم وضع زمن التكرار في المجموعه ( '..text:match('ضع زمن التكرار (.*)')..' )', 1, 'md') end
if text == 'الترحيب' then 
local getwelcom = devalsh:get(DEVRMBO..'welcome:'..msg.chat_id_)  
if getwelcom then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, ''..getwelcom..'', 1, 'html') 
else 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📛¦* عذرا لم يتم وضع الترحيب \n', 1, 'md') 
end 
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز للـكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
end
else
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد هو مميز \n🍃'   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع القناة في البوت *\n💥', 1, 'md') 
return false  end
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد هو مميز'   
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز للـكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز للـكروب'   
devalsh:sadd(DEVRMBO..'vip:group'..msg.chat_id_,user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع تنزيل القناة في البوت *\n💥', 1, 'md') 
return false  end
if result and result.type_ and result.type_.user_ and result.type_.user_.type_ and result.type_.user_.type_.ID == "UserTypeBot" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n??', 1, 'md') 
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,result.id_) then
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,result.id_)  
else
setvip = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز'   
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,user) then
if data.username_ == false then
setvip = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المميزين\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, setvip, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,user)  
else
setvip = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المميزين'   
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvip, 1, 'md') 
...
local list = devalsh:smembers(DEVRMBO..'mutes'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مكتومين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المكتومين *\n', 1, 'md') 
end 
if text ==('مسح المحظورين') and is_mod(msg) then 
local list = devalsh:smembers(DEVRMBO..'alsh:baned'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين *\n', 1, 'md') 
end 

if text == 'مسح المميزين' and is_mod(msg) then  
local list = devalsh:smembers(DEVRMBO..'vip:group'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين *\n', 1, 'md') 
end 
if text ==('مسح الادمنيه') and is_monsh(msg) then 
local list = devalsh:smembers(DEVRMBO..'mods:'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد ادمنيه ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من الادمنيه *\n', 1, 'md') 
end
if text ==('مسح المدراء') and is_owner(msg) then 
local list = devalsh:smembers(DEVRMBO..'modergroup'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مدراء ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المدراء *\n', 1, 'md') 
end 
if text == 'مسح المنشئين' and is_sudo(msg) then 
local list = devalsh:smembers(DEVRMBO..'moder'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد منشئين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المنشئين *\n', 1, 'md') 
end

if text == 'مسح المميزين عام' and is_devrami(msg) then    
local list = devalsh:smembers(DEVRMBO..'vip:groups')  
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*??¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO.."vip:groups",v)  
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md') 
end
if text == 'مسح المطورين' and is_devrami(msg) then   
local list = devalsh:smembers(DEVRMBO..'sudo:bot')  
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO.."sudo:bot",v)  
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md') 
end
if text == 'مسح قائمه العام' and is_devrami(msg) then 
local list = devalsh:smembers(DEVRMBO..'alsh:gbaned')  
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO.."alsh:gbaned",v)  
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md') 
end	 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز عام في البوت\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'vip:groups',result.sender_user_id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام في البوت'   
devalsh:sadd(DEVRMBO..'vip:groups',result.sender_user_id_)  
seavusername(result.sender_user_id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
end
else
if data.username_ == false then
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
devalsh:sadd(DEVRMBO..'vip:groups',result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مميز عام'   
devalsh:sadd(DEVRMBO..'vip:groups',result.id_)  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مميز عام البوت\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مميز عام البوت'   
devalsh:sadd(DEVRMBO..'vip:groups',user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'vip:groups',result.sender_user_id_) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'vip:groups',result.sender_user_id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
devalsh:srem(DEVRMBO..'vip:groups',result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'vip:groups',result.id_) then
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
devalsh:srem(DEVRMBO..'vip:groups',result.id_)  
else
setvips = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مميز عام'   
devalsh:srem(DEVRMBO..'vip:groups',result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'vip:groups',user) then
if data.username_ == false then
setvips = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من مميزين عام\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, setvips, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'vip:groups',user)  
else
setvips = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من مميزين عام'   
devalsh:srem(DEVRMBO..'vip:groups',user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setvips, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مدير'   
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,result.id_)  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مدير للـكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مدير للـكروب'   
devalsh:sadd(DEVRMBO..'modergroup'..msg.chat_id_,user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مدير'   
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المدراء\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المدراء'   
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ادمن'   
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,result.id_)  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه ادمن للـكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه ادمن للـكروب'   
devalsh:sadd(DEVRMBO..'mods:'..msg.chat_id_,user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس ادمن'   
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من الادمنيه\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من الادمنيه'   
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه منشئ للـكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_)  
seavusername(result.sender_user_id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
end
else
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد هو منشئ \n🍃'   
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو منشئ'   
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,result.id_)  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه منشئ للـكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه منشئ للـكروب'   
devalsh:sadd(DEVRMBO..'moder'..msg.chat_id_,user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,result.id_) then
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,result.id_)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس منشئ'   
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,user) then
if data.username_ == false then
setmonsh = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المنشئين\n'   
alshmonshn(msg.chat_id_, user, msg.id_, setmonsh, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,user)  
else
setmonsh = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المنشئين'   
devalsh:srem(DEVRMBO..'moder'..msg.chat_id_,user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, setmonsh, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
devalsh:sadd(DEVRMBO..'sudo:bot',result.sender_user_id_)  
seavusername(result.sender_user_id_) 
...
return false  end
if result.id_ then  
if not devalsh:sismember(DEVRMBO..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
devalsh:sadd(DEVRMBO..'sudo:bot',result.id_)  
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو مطور'   
devalsh:sadd(DEVRMBO..'sudo:bot',result.id_)  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تـرقيتـه مطور البوت\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تـم تـرقيتـه مطور البوت'   
devalsh:sadd(DEVRMBO..'sudo:bot',user)  
seavusername(user) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'sudo:bot',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'sudo:bot',result.sender_user_id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
devalsh:srem(DEVRMBO..'sudo:bot',result.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end
if result.id_ then  
if devalsh:sismember(DEVRMBO..'sudo:bot',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
devalsh:srem(DEVRMBO..'sudo:bot',result.id_)  
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* بالتاكيد هو ليس مطور'   
devalsh:srem(DEVRMBO..'sudo:bot',result.id_)  
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع رفع وتنزيل البوتات *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'sudo:bot',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تنزيله من المطورين\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'sudo:bot',user)  
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` *❫*\n*🚸¦* تم تنزيله من المطورين'   
devalsh:srem(DEVRMBO..'sudo:bot',user)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت وليس لدي قيود * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
},function(arg,data) 
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) or devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_) or devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم رفع قيوده\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_)   
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,user) or devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,user) or devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم رفع قيوده\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
...
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,user) 
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,user)   
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,user) 
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ هاذا المعرف قناة وليس معرف حساب *\n💥', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت وليس لدي قيود * \n', 1, 'md')  
return false  end 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) or devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.id_) or devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم رفع قيوده\n🍃'   
...
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) 
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_)   
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,result.id_)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم رفع قيوده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت ولست محظور * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ يرجى تفعيل صلاحيه حظر المستخدمين لاتمكن من الغاء حظره *\n💥', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,user)   
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع حظر القناة *\n💥', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت ولست محظور * \n', 1, 'md')  
return false  end 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره\n🍃'   
devalsh:srem(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
for k, v in pairs(list) do 
local rami = devalsh:get(DEVRMBO.."user:Name" .. v)
if rami then
local username = rami
...
alsh_sendMssg(msg.chat_id_,t,msg.id_,'md')
end  
...
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
return false  end 
if alsh1(msg.chat_id_,result.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع حظر » ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:gbaned',result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروبات\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
devalsh:sadd(DEVRMBO..'alsh:gbaned',result.sender_user_id_)   
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.sender_user_id_) end
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره عام من الكروبات\n🍃'   
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.sender_user_id_) end
devalsh:sadd(DEVRMBO..'alsh:gbaned',result.sender_user_id_)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
return false  end 
if alsh1(msg.chat_id_,result.id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع حظر » ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n🍃', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره عام من الكروبات\n🍃'   
devalsh:sadd(DEVRMBO..'alsh:gbaned',result.id_)   
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.id_) end
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره عام من الكروبات\n🍃'     
devalsh:sadd(DEVRMBO..'alsh:gbaned',result.id_)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
return false  end 
if alsh1(msg.chat_id_,user) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع حظر » ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
zo = '*📬¦ العضــو » ❪ '..user..' ❫\n🚸¦ تـم حظره عام من الكروبات\n🍃*'   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,user) end
devalsh:sadd(DEVRMBO..'alsh:gbaned',user)   
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره عام من الكروبات\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,user) end
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ يرجى تفعيل صلاحيه حظر المستخدمين لاتمكن من الغاء حظره عام *\n💥', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'alsh:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n??'   
devalsh:srem(DEVRMBO..'alsh:gbaned',result.sender_user_id_)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'alsh:gbaned',user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء حظره عام\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'alsh:gbaned',user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
devalsh:srem(DEVRMBO..'alsh:gbaned',user)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'alsh:gbaned',result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء حظره عام\n🍃'   
devalsh:srem(DEVRMBO..'alsh:gbaned',result.id_)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تم الغاء حظره عام\n🍃'   
devalsh:srem(DEVRMBO..'alsh:gbaned',result.id_)   
...
if msg.can_be_deleted_ == false then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, "*🚨¦* انا لست ادمن يرجى رفعي والمحاوله مره اخره\n", 1, "md") 
return false  end 
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع كتم نفسي * ', 1, 'md')  
return false  end 
if alsh1(msg.chat_id_,result.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع كتم » ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
},function(arg,data) 
if not devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*📬¦* تـم كتمه من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
return false  end 
if alsh1(msg.chat_id_,result.id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع كتم » ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
if not devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,result.id_)   
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم كتمه من الكروب\n🍃'     
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,result.id_)   
...
return false  end 
if alsh1(msg.chat_id_,user) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع كتم » ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع كتم ادمنية المجموعه *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم كتمه من الكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم كتمه من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'mutes'..msg.chat_id_,user)   
seavusername(user) 
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت ولست مكتوم * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
},function(arg,data) 
if devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,result.sender_user_id_)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء كتمه\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,user)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'mutes'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء كتمه\n🍃'   
devalsh:srem(DEVRMBO..'mutes'..msg.chat_id_,result.id_)   
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
else
...
if not is_owner(msg) and not is_canban(msg) and devalsh:get(DEVRMBO..'LOCK:BAN:KICK'..msg.chat_id_) then 
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع الحظر لقد تم تعطيل { الحظر - الطرد } \n👨🏻‍✈️*")   
return false  end 
if devalsh:sismember(DEVRMBO..'LOCK:BAN'..msg.chat_id_,msg.sender_user_id_) then
alsh_send(msg.chat_id_,msg.id_,"*📮¦ تم وضع القيود عليك لا تستطيع { طرد او حظر } المستخدمين \n👨🏻‍✈️*")   
return false  end 
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع حظر ادمنية المجموعه *\n💥', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ ليس لدي صلاحية حظر المستخدمين *\n💥', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,result.sender_user_id_)   
seavusername(result.sender_user_id_) 
...
alsh_send(msg.chat_id_,msg.id_,"*📮¦ انت لست ادمن \n👨🏻‍✈️*")   
end
end
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا لست ادمن في المجموعه *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_)   
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم حظره من الكروب\n🍃'     
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,result.id_)   
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'alsh:baned'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم حظره من الكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم حظره من الكروب\n🍃'   
devalsh:sadd(DEVRMBO..'alsh:baned'..msg.chat_id_,user)   
seavusername(user) 
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا تستطيع طرد القناة *\n💥', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع طرد نفسي * \n', 1, 'md')  
return false  end 
...
return false  end
if alsh1(msg.chat_id_,result.id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع طرد » ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" }, 
},function(arg,ban) 
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع طرد ادمنية المجموعه *\n💥', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ ليس لدي صلاحية حظر المستخدمين *\n💥', 1, 'md') 
return false  end
...
return false  end 
if alsh1(msg.chat_id_,result.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع طرد » ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
tdcli_function ({
ID = "GetUser",
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد تـم طرده من الكروب\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
devalsh:sadd(DEVRMBO..'alsh:kick'..msg.chat_id_,result.sender_user_id_)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* بالتاكيد تـم طرده من الكروب\n🍃'   
seavusername(result.sender_user_id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
return false  end 
if alsh1(msg.chat_id_,user) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع طرد » ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
...
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم طرده من الكروب\n🍃'     
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
devalsh:sadd(DEVRMBO..'alsh:kick'..msg.chat_id_,user)   
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم طرده من الكروب\n🍃'     
devalsh:sadd(DEVRMBO..'alsh:kick'..msg.chat_id_,user)   
seavusername(user) 
...
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لأ أستطيع تقييد نفسي * ', 1, 'md')  
return false  end 
if alsh1(msg.chat_id_,result.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع تقييد » ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
},function(arg,data) 
if not devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
...
devalsh:sadd(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.."") 
seavusername(result.sender_user_id_) 
...
return false  end 
if alsh1(msg.chat_id_,result.id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع تقييد » ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
if not devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
devalsh:sadd(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) 
devalsh:set(DEVRMBO.."user:Name"..result.id_,"@"..username)
else
zo = '*📮¦* العضــو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* بالتاكيد تـم تقييده من الكروب\n🍃'     
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.."") 
...
return false  end 
if alsh1(msg.chat_id_,user) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ عذرآ لآ أستطيع تقييد » ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع تقييد ادمنية المجموعه *\n💥', 1, 'md') 
return false  end
if not devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تـم تقييده من الكروب\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
devalsh:sadd(DEVRMBO..'tedmembars'..msg.chat_id_,user) 
else
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..user..'` ❫\n*🚸¦* تـم تقييده من الكروب\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.."") 
devalsh:sadd(DEVRMBO..'tedmembars'..msg.chat_id_,user) 
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت ولست مقييد * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
},function(arg,data) 
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.sender_user_id_) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
alshmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
local user = user1 or user2
if tonumber(user) == tonumber(bot_id) then  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ انا البوت ولست مقيد * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,user) then
if data.username_ == false then
zo = '📮¦ العضــو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم الغاء تقييده\n🍃'   
alshmonshn(msg.chat_id_, user, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))  
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦ لا استطيع استخراج معلوماته*\n💥', 1, 'md') 
return false  end
if devalsh:sismember(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) then
zo = '*📮¦* العضــو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` ❫\n*🚸¦* تم الغاء تقييده\n🍃'   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
devalsh:srem(DEVRMBO..'tedmembars'..msg.chat_id_,result.id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
...
if num > 1000 then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, ' تستطيح المسح فقط (1000) رساله \n', 1, 'md') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'🗑¦ تم تنظيف {'..num..'} رساله من الكروب \n', 1, 'md')  
end  

if tonumber(msg.reply_to_message_id_) > 0 then
if text==("حذف") and is_mod(msg) then 
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_,  message_ids_={[0] = tonumber(msg.reply_to_message_id_),msg.id_} },function(arg,data)  if data.code_ == 6 then alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* انا لست ادمن او ليست لدي صلاحيه حذف الرسائل \n💥", 1, 'md')   return false  end  end,nil) 
end	 
end
if text and text:match('^منع (.*)') and is_mod(msg) then 
local rami = text:match('^منع (.*)') 
if devalsh:sismember(DEVRMBO..'filters:'..msg.chat_id_,rami) then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ الكلمه » ❪ '..rami..' ❫*\n*📪¦* بالتأكيد تم منع هاذه الكلمه \n💥', 1, 'md') 
else
devalsh:sadd(DEVRMBO..'filters:'..msg.chat_id_,rami) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ الكلمه » ❪ '..rami..' ❫*\n*💠¦* تم منع ارسال هاذه الكلمه \n✓', 1, 'md') 
end
end 
if text and text:match('^الغاء المنع (.*)')  and is_mod(msg) then  
local rami = text:match('^الغاء المنع (.*)') 
if not devalsh:sismember(DEVRMBO..'filters:'..msg.chat_id_,rami) then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*⚜¦ الكلمه » ❪ '..rami..' ❫*\n*🗳¦* بالتأكيد تم الغاء منع الكلمه\n💥', 1, 'md') 
else
devalsh:srem(DEVRMBO..'filters:'..msg.chat_id_,rami) 
...
if text ==('مسح قائمه المنع') and is_mod(msg) then devalsh:del(DEVRMBO..'filters:'..msg.chat_id_) alsh_sendMsg(msg.chat_id_, msg.id_, 1,'📇*¦* تم مسح قائمه المنع', 1, 'md') end 
if text == ('قائمه المنع') and is_mod(msg) then  
local list = devalsh:smembers(DEVRMBO..'filters:'..msg.chat_id_) 
local t = '*📋¦* قائمه منع الكلمات 🍂 \n--------------------\n' for k,v in pairs(list) do t = t..'*'..k.."» { * `"..v.."` *} *\n"  end if #list == 0 then t = '*🚨¦* قائمه المنع فارغه' end alsh_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') end 
if text ==('تثبيت') and msg.reply_to_message_id_ ~= 0 and is_mod(msg) then  
if devalsh:sismember(DEVRMBO..'lock:pin',msg.chat_id_) and not is_monsh(msg) then
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* التثبيت مقفل في المجموعه \n🍃", 1, 'md')  
return false  end
if devalsh:sismember(DEVRMBO..'LOCK:PINMSG'..msg.chat_id_,msg.sender_user_id_) then
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* تم منعك من التثبيت هنا لا تستطيع التثبيت \n🍃", 1, 'md')  
return false  end
local id = msg.id_ 
local msgs = {[0] = id}  
tdcli_function ({
...
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* بالتاكيد تم تثبيت الرساله \n🍃", 1, 'md')  
elseif data.code_ == 6 then
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* لا استطيع تثبيت الرساله انا لست ادمن \n✘", 1, 'md')  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* ليس لدي صلاحيه لتثبيت الرسائل \n✘", 1, 'md')  
else
alsh_sendMsg(msg.chat_id_, msg.id_, 1, "*🗯¦* الـرسالــه تــم تثـبيتهـا بنجاح \n✓", 1, 'md')   
end 
end,nil) 
end
if text == 'اطردني' and not devalsh:get(DEVRMBO.."lock:kickme"..msg.chat_id_)   then 
tdcli_function ({
ID = "GetChatMember",
chat_id_ = msg.chat_id_,
user_id_ = msg.sender_user_id_},
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* لا استطيع طردك انته منشئ المجموعه\n🍃', 1, 'md') 
return false  end
if data.status_.ID == "ChatMemberStatusEditor" then
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* لا استطيع طردك انت ادمن في المجموعه \n🍃', 1, 'md') 
return false  end
if not msg.can_be_deleted_ == true then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, "*📮¦* لا استطيع الطرد انا لست ادمن هنا \n💥", 1, "md") 
devalsh:del(DEVRMBO..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end 
if alsh1(msg.chat_id_,msg.sender_user_id_) then 
if tonumber(msg.sender_user_id_) == tonumber(SUDO) then
t = 'المطور'
elseif devalsh:sismember(DEVRMBO..'sudo:bot',msg.sender_user_id_) then
t = 'المطور'
elseif devalsh:sismember(DEVRMBO..'moder'..msg.chat_id_,msg.sender_user_id_) then
t = 'المنشئ'
elseif devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,msg.sender_user_id_) then
t = 'المدير'
elseif devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,msg.sender_user_id_) then
t = 'الادمن'
elseif devalsh:sismember(DEVRMBO..'vip:groups',msg.sender_user_id_) then
t = 'مميز عام'
elseif devalsh:sismember(DEVRMBO..'vip:group'..msg.chat_id_,msg.sender_user_id_) then
t = 'مميز'
else
t = ' '
end
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n🍃', 1, 'md') 
devalsh:del(DEVRMBO..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end  
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
devalsh:set(DEVRMBO..hash, "waite") 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '📮*¦* رائع الان يمكنك تطبيق الشروط\n⚀*¦* ارسل ❪ نعم ❫ ليتم طردك\n*⚁¦* ارسل ❪ لا ❫ لالغاء طردك\n💥', 1, 'md') 
end,nil)
end 
if text then 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if text:match("^نعم$") and devalsh:get(DEVRMBO..hash) == "waite" then 
devalsh:set(DEVRMBO..hash, "نعم") 
elseif text:match("^لا$") and devalsh:get(DEVRMBO..hash) == "waite" then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📬¦* حسنآ لن يتم طردك من هنا\n💭', 1, 'md') 
devalsh:del(DEVRMBO..hash, true) 
end 
end 
local hash = 'kick:'..msg.chat_id_..':'..msg.sender_user_id_ 
if devalsh:get(DEVRMBO..hash) then 
if devalsh:get(DEVRMBO..hash) == "نعم" then 
if alsh1(msg.chat_id_,msg.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n🍃', 1, 'md') 
else  
kick(msg,msg.chat_id_,msg.sender_user_id_)  
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* تم طردك من هنا \n🍃', 1, 'md') 
end 
devalsh:del(DEVRMBO..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
end 
end
if text == 'نزلني' and not devalsh:get(DEVRMBO.."lock:demrtpa"..msg.chat_id_)   then 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ devalsh:set(DEVRMBO..hash, "waite") 
if alsh2(msg.chat_id_,msg.sender_user_id_) then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* انت من ضمن ❪ '..get_mok2(msg.chat_id_,msg.sender_user_id_)..' ❫ ليس من صلاحياتي تنزيلك \n⭐', 1, 'md') 
devalsh:del(DEVRMBO..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else  
if not is_memar(msg)  then  
devalsh:del(DEVRMBO..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* انت هنا لست سواء عضو ليس لديك رتبه في البوت\n💥', 1, 'md') 
devalsh:del(DEVRMBO..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '📛*¦* اهلا بك عزيزي ❪ '..get_mok3(msg.chat_id_,msg.sender_user_id_)..' ❫🍃\n📮*¦* رائع الان يمكنك تطبيق الشروط\n⚀*¦* ارسل ❪ نعم ❫ ليتم تنزيلك\n*⚁¦* ارسل ❪ لا ❫ لالغاء تنزيلك\n🍃', 1, 'md') 
end 
end 
end 
if text then 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* لن يتم تنزيلك ستبقى ضمن ❪ '..t..' ❫\n💥', 1, 'md') 
end 
end 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ 
if devalsh:get(DEVRMBO..hash) then 
if devalsh:get(DEVRMBO..hash) == "نعم" then 
devalsh:srem(DEVRMBO..'modergroup'..msg.chat_id_,msg.sender_user_id_)  
devalsh:srem(DEVRMBO..'mods:'..msg.chat_id_,msg.sender_user_id_) 
devalsh:srem(DEVRMBO..'vip:group'..msg.chat_id_,msg.sender_user_id_) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '*📮¦* تم تنزيلك الان انت عضو في المجموعه\n🍃', 1, 'md') 
devalsh:del(DEVRMBO..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
end 
end
if text == "تفعيل الاضافه" and is_owner(msg) then 
if not msg.can_be_deleted_ == true then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, "*🚨¦* تنبيــه انا لست ادمن يرجى ترقيتي ادمن هنا 👮\n", 1, "md") 
else  
devalsh:set(DEVRMBO..'add:mepr:'..msg.chat_id_,true) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,"📮❯ تم تفعيل الاضافه اجباري", 1, 'md') 
end 
end
if text == "تعطيل الاضافه" and is_owner(msg) then 
devalsh:del(DEVRMBO..'add:mepr:'..msg.chat_id_) 
devalsh:del(DEVRMBO..'meaddwy:'..msg.chat_id_) 
devalsh:del(DEVRMBO..'meaddrami:'..msg.chat_id_) 
local rami = devalsh:keys("addedrami:*") 
for i=1,#rami do devalsh:del(DEVRMBO..rami[i]) 
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,"📮❯ تم تعطيل الاضافه اجباري", 1, 'md') 
end
if text and text:match("^ضع عدد الاضافه (%d+)$") and is_owner(msg) then 
local numadded = string.match(text, "^ضع عدد الاضافه (%d+)$") 
devalsh:set(DEVRMBO..'setadd:'..msg.chat_id_,numadded) 
alsh_sendMsg(msg.chat_id_, msg.id_,  1, "📬❯ تم وضع عدد الاضافه *{ "..numadded..' }*', 1, 'md') 
end 
...
local nummsg = tonumber(devalsh:get(DEVRMBO..'groupmsg:'..msg.chat_id_..':')) 
local nummsgg = devalsh:get(DEVRMBO..'groupmsg:'..msg.chat_id_..':') 
...
if text and text:match("^مشاهده منشور$") then devalsh:set(DEVRMBO..'viewchannel'..msg.sender_user_id_,true) alsh_sendMsg(msg.chat_id_, msg.id_, 1, '♼*¦* حسننا ارسل التوجيه من القناة سارسل عدد المشاهدات', 1, 'md') end 
if text and text:match("^ضع رد تواصل$") and is_devrami(msg) then   devalsh:setex(DEVRMBO.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  alsh_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور$") and is_devrami(msg) then devalsh:setex(DEVRMBO.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  alsh_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه ستارت$") and is_devrami(msg) then devalsh:setex(DEVRMBO.."start:msgofstart" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  alsh_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
if msg.content_.ID == 'MessageChatChangeTitle' then tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,data)  devalsh:set(DEVRMBO..'group:name'..msg.chat_id_,data.title_) end,nil)  end
...
alsh_sendMsg(msg.chat_id_,msg.id_, 1, "*📬¦* تم وضع اسم للمجموعه \n", 1, 'md')  
devalsh:set(DEVRMBO..'group:name'..result.chat_id_,result.content_.text_)
end
end,nil) 
end 
...
if data.code_ == 3 then
alsh_sendMsg(result.chat_id_, result.id_, 1, '*💥¦* عذرا انا لست ادمن هنا \n', 1, 'md') 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
alsh_sendMsg(result.chat_id_, result.id_, 1, '*📮¦* عذرا ليست لدي صلاحيه تغير معلومات المجموعه \n', 1, 'md') 
else
alsh_sendMsg(result.chat_id_, result.id_, 1, '*🎆¦* تم تغيير صورة المجموعه \n✓', 1, 'md') 
end
end, nil) 
end   
end 
...
if devalsh:get(DEVRMBO..'lock:rep:rd'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل الردود بالرد *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:rep:rd'..msg.chat_id_)  
else
...
if not devalsh:get(DEVRMBO..'lock:rep:rd'..msg.chat_id_) then
rami = '*📮¦ تم تعطيل الردود بالرد *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:rep:rd'..msg.chat_id_,true)   
else
...
if devalsh:get(DEVRMBO..'lock:rep'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل الردود *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:rep'..msg.chat_id_)  
else
...
if not devalsh:get(DEVRMBO..'lock:rep'..msg.chat_id_) then
rami = '*📮¦ تم تعطيل الردود *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:rep'..msg.chat_id_,true)   
else
...
if devalsh:get(DEVRMBO..'lock:id'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل الايدي *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:id'..msg.chat_id_) 
else
...
if not devalsh:get(DEVRMBO..'lock:id'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل الايدي *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:id'..msg.chat_id_,true) 
else
...
if devalsh:get(DEVRMBO..'lock:id:photo'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل الايدي *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:id:photo'..msg.chat_id_) 
devalsh:del(DEVRMBO..'lock:id'..msg.chat_id_) 
else
rami = '*📮¦ بالتاكيد تم تفعيل الايدي  *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
...
if not devalsh:get(DEVRMBO..'lock:id:photo'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل الايدي بالصوره *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:id:photo'..msg.chat_id_,true) 
devalsh:set(DEVRMBO..'lock:id'..msg.chat_id_,true) 
else
...
if devalsh:get(DEVRMBO..'lock:kickme'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل امر اطردني *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:kickme'..msg.chat_id_) 
else
...
if not devalsh:get(DEVRMBO..'lock:kickme'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل امر اطردني *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:kickme'..msg.chat_id_,true) 
else
...
if devalsh:get(DEVRMBO..'lock:demrtpa'..msg.chat_id_) then
rami = '*📮¦ تم تفعيل امر نزلني *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:demrtpa'..msg.chat_id_) 
else
...
if not devalsh:get(DEVRMBO..'lock:demrtpa'..msg.chat_id_) then
rami = '*📮¦ تم تعطيل امر نزلني *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:demrtpa'..msg.chat_id_,true) 
else
...
if devalsh:get(DEVRMBO..'lock:bot:free'..bot_id) then
rami = '*📮¦ تم تفعيل البوت الخدمي *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:bot:free'..bot_id) 
else
...
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:bot:free'..bot_id,true) 
else
...
if devalsh:get(DEVRMBO..'lock:klsh:add'..bot_id) then
rami = '*📮¦ تم تفعيل كليشه الترحيب عند الاضافه*\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:klsh:add'..bot_id) 
else
...
if not devalsh:get(DEVRMBO..'lock:klsh:add'..bot_id) then
rami = '*📮¦ تم تعطيل كليشه الترحيب عند الاضافه*\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:klsh:add'..bot_id,true) 
else
...
if devalsh:get(DEVRMBO..'lock:botl'..bot_id) then
rami = '*📮¦ تم تفعيل البوت التواصل *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'lock:botl'..bot_id) 
else
...
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'lock:botl'..bot_id,true) 
else
...
if devalsh:get(DEVRMBO..'LOCK:BAN:KICK'..msg.chat_id_)  then
rami = '*📮¦ تم تفعيل { الحظر - الطرد } *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:del(DEVRMBO..'LOCK:BAN:KICK'..msg.chat_id_) 
else
...
if not devalsh:get(DEVRMBO..'LOCK:BAN:KICK'..msg.chat_id_)  then
rami = '*📮¦ تم تعطيل { الحظر - الطرد } *\n✓' 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, rami, 1, "md") 
devalsh:set(DEVRMBO..'LOCK:BAN:KICK'..msg.chat_id_,true) 
else
...
local dev = devalsh:get(DEVRMBO.."dev") 
if dev then 
alsh_sendMsg(msg.chat_id_, msg.id_,1,''..check_markdown(dev)..'',1,'md') 
else 
alsh_sendMsg(msg.chat_id_, msg.id_,1,'💢*¦* عذرا لم يتم وضع كليشه المطور ',1,'md')  
end  
end
if text == "حذف كليشه المطور" and is_devrami(msg) then  
devalsh:del(DEVRMBO.."dev") 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") 
end 
if text == "جلب رد التواصل" and is_devrami(msg) then 
if devalsh:get(DEVRMBO.."pvstart") then
pvstart = devalsh:get(DEVRMBO.."pvstart")
alsh_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(pvstart)..'', 1, 'md') 
else 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا يوجد رد في التواصل \n📮¦* ارسل `ضع رد التواصل`\n🍃', 1, 'md') 
end 
end
if text == "جلب كليشه ستارت" and is_devrami(msg) then  
local start = devalsh:get(DEVRMBO.."start:msgofstart1")  
if start then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,''..check_markdown(start)..'', 1, 'md') 
else 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*✉¦ لا توجد كليشه في ستارت \n📮¦* ارسل `ضع كليشه ستارت`\n🍃', 1, 'md') 
end 
end
if text == "حذف رد التواصل" and is_devrami(msg) then  
devalsh:del(DEVRMBO.."pvstart") 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") 
end 
if text == "حذف كليشه ستارت" and is_devrami(msg) then  
devalsh:del(DEVRMBO.."start:msgofstart1") 
alsh_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") 
end 
if text == 'معلوماتي' or text=='موقعي' or text == 'اكشفني' then 
local msgrami = 500 
local msggsrami = devalsh:get(DEVRMBO..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
local nupmsgg =  tonumber((msggsrami / msgrami) * 100)   
local msguser = tonumber(devalsh:get(DEVRMBO..'msg:user:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local ramimsg = (devalsh:get(DEVRMBO..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if is_devrami(msg) then 
t = 'مطور اساسي 🌟'  
elseif is_sudo(msg) then 
t = 'مطور البوت ✨'  
...
local whatnumadded = (devalsh:get(DEVRMBO..'setadd:'..msg.chat_id_) or 0) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,"📇*¦* عدد الاضافات المطلوبه\n📮*¦* *"..whatnumadded.."* اشخاص \n", 1, 'md') 
end
if text == "مسح رسايلي" or text == "مسح رسائلي" or text == "حذف رسايلي" or text == "حذف رسائلي" then  
local getmsgs = devalsh:get(DEVRMBO..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local rami = '\n*📨¦ عدد رسائلك » ❪ '..getmsgs..' ❫ رساله\n📮¦ تم مسح جميع رسائلك *\n🍃'  
alsh_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md')  
devalsh:del(DEVRMBO..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) 
end
...
if text == "تفاعلي" then
local msguser = tonumber(devalsh:get(DEVRMBO..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
rami = '*📮¦ تفاعلك هنا » ❪ '..formsgg(msguser)..' ❫\n🍃*'
alsh_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
end
if text == "جهاتي" then
local addmempar = tonumber(devalsh:get(DEVRMBO..'add:mempar'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
if addmempar == 0 then
rami = '*📮¦ عذرا انت لم تقم باضافه احد هنا *'
alsh_sendMsg(msg.chat_id_, msg.id_, 1,rami, 1, 'md') 
else
ramia = '*📮¦ عدد جهاتك المضافه هنا » ❪ '..addmempar..' ❫ جهة \n💥*'
alsh_sendMsg(msg.chat_id_, msg.id_, 1,ramia, 1, 'md') 
end
end
if text ==('رتبتي')  then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
devalsh:setex(DEVRMBO.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
local ramiid= [[
*📮¦ اهلا عزيزي المطور 
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1,ramiid, 1, 'md')
return false  
end 
if text == 'مسح تغير الايدي' and is_monsh(msg) or text == 'حذف تغير الايدي' and is_monsh(msg) then
devalsh:del(DEVRMBO.."KLISH:ID"..msg.chat_id_)
alsh_sendMsg(msg.chat_id_, msg.id_, 1,  '*📮¦ تم مسح كليشه الايدي *\n', 1, 'md')
return false  
end 
if devalsh:get(DEVRMBO.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم الغاء الامر *\n✓", 1, "md") 
devalsh:del(DEVRMBO.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  end 
devalsh:del(DEVRMBO.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
...
devalsh:set(DEVRMBO.."KLISH:ID"..msg.chat_id_,CHENGER_ID)
...
NUMPGAME = (devalsh:get(DEVRMBO..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
...
if not devalsh:get(DEVRMBO..'lock:id'..msg.chat_id_) then      
local get_id_text = devalsh:get(DEVRMBO.."KLISH:ID"..msg.chat_id_)
if get_id_text then
...
alsh_sendMsg(msg.chat_id_, msg.id_, 1,get_id(msg,rami,get_id_text)..'\n• لا يمكنني عرض صورتك لانك قمت بحظر البوت\n', 1, 'html')   
else
...
local get_id_text = devalsh:get(DEVRMBO.."KLISH:ID"..msg.chat_id_)
if get_id_text then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,get_id(msg,rami,get_id_text), 1, 'html')   
else
...
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  devalsh:set(DEVRMBO..'pinned'..msg.chat_id_,data.pinned_message_id_)  end,nil)
function by_reply(extra, result, success)   
if not msg.can_be_deleted_ == true then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ انا لست ادمن هنا يرجى ترقيتي \n👨🏻‍✈️*")   
return false 
end      
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال التثبيت \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
return false  
end    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusEditor" or da and da.status_.ID == "ChatMemberStatusCreator" then
devalsh:sadd(DEVRMBO..'LOCK:PINMSG'..msg.chat_id_,result.sender_user_id_)     
...
alsh_send(msg.chat_id_,msg.id_,"*📮¦ هذا مجرد عضو هنا\n👨🏻‍✈️*")   
end
end
end,nil)   
end,nil)
...
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا استطيع منع القنواة\n👨🏻‍✈️*")   
return false 
end      
if not msg.can_be_deleted_ == true then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ انا لست ادمن هنا يرجى ترقيتي \n👨🏻‍✈️*")   
...
alsh_send(msg.chat_id_,msg.id_,"*📮¦ المعرف غير صحيح \n👨🏻‍✈️*")   
return false  
end   
devalsh:sadd(DEVRMBO..'LOCK:PINMSG'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من التثبيت هنا\n',result.id_)   
else
if devalsh:sismember(DEVRMBO..'modergroup'..msg.chat_id_,result.id_) then
tt = 'مدير'
elseif devalsh:sismember(DEVRMBO..'mods:'..msg.chat_id_,result.id_) then
tt = 'ادمن'
else
tt = 'عضو'
end
...
alsh_send(msg.chat_id_,msg.id_,"*📮¦ هذا مجرد عضو \n👨🏻‍✈️*")   
end
end
end,nil)
end
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:PINMSG'..msg.chat_id_,result.sender_user_id_)     
...
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
alsh_send(msg.chat_id_,msg.id_,"*📮¦ هاذا معرف قناة \n👨🏻‍✈️*")   
return false 
end      
devalsh:srem(DEVRMBO..'LOCK:PINMSG'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع التثبيت عنه \n',result.id_)   
end    
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الملصقات \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:STEKR'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:STEKR'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الملصقات هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:STEKR'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:STEKR'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الملصقات عنه\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الصور \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:PHOTO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:PHOTO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الصور هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:PHOTO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:PHOTO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الصور عنه\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الاونلاين \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:INLIN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:INLIN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الاونلاين هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:INLIN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:INLIN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الاونلاين عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال التوجيه \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:FWD'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:FWD'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال التوجيه هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:FWD'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:FWD'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع التوجيه عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الروابط \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:LINKS'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:LINKS'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الروابط هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:LINKS'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:LINKS'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الروابط عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال السيلفي \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:SELPHY'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:SELPHY'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال السيلفي هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:SELPHY'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:SELPHY'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع السيلفي عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الصوت \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:VICO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:VICO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الصوت هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:VICO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:VICO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الصوت عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الفيديو \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:VIDEO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:VIDEO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الفيديو هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:VIDEO'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:VIDEO'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الفيديو عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال الماركداون \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:MARKDWN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:MARKDWN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال الماركداون هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:MARKDWN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:MARKDWN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع الماركداون عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال المتحركه \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:GIF'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:GIF'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال المتحركه هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:GIF'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:GIF'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع المتحركه عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من ارسال المعرفات \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:USERNAME'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:USERNAME'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من ارسال المعرفات هنا\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:USERNAME'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:USERNAME'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منع المعرفات عنه \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ لا تستطيع منعي من { طرد - حظر } المستخدمين \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
alsh_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'LOCK:BAN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'LOCK:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منعه من » ( طرد - حظر ) المستخدمين\n',result.id_)   
end
tdcli_function ({ID = "SearchPublicChat",username_ = user},py_username,nil) 
end 
...
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'LOCK:BAN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:srem(DEVRMBO..'LOCK:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منعه من ( طرد - حظر ) المستخدمين \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ انا بوت استطيع طرد - حظر المستخدمين \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:sadd(DEVRMBO..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
alsh_send(msg.chat_id_,msg.id_,"*📮¦ انا بوت لا تستطيع منعي من الحظر - الطرد \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
devalsh:srem(DEVRMBO..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
...
devalsh:sadd(DEVRMBO..'SET:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم منحه صلاحية ( طرد - حظر ) المستخدمين \n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
...
devalsh:srem(DEVRMBO..'SET:BAN'..msg.chat_id_,result.id_)     
sendMention(msg,msg.chat_id_,'📮¦ العضو » {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n📬¦ تم الغاء منحه صلاحية ( طرد - حظر ) المستخدمين\n',result.id_)   
end    
tdcli_function ({ID = "SearchPublicChat",username_ = username},py_username,nil) 
end
if text ==('مسح صلاحيات الحظر') and is_owner(msg) then 
local list = devalsh:smembers(DEVRMBO..'SET:BAN'..msg.chat_id_) 
if #list == 0 then
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد اعضاء لديهم صلاحياة الحظر ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
devalsh:srem(DEVRMBO..'SET:BAN'..msg.chat_id_,v) 
num = num + 1
end 
alsh_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من الذين لديهم صلاحيات الحظر *\n', 1, 'md') 
end
...
devalsh:srem(DEVRMBO..'bot:gpsby:id',idch) 
devalsh:srem(DEVRMBO.."bot:gpsby:id:add",idch) 
devalsh:srem(DEVRMBO.."bot:gps:id", idch) 
tdcli_function({ID="GetChat",chat_id_ = '-100'..data.channel_.id_},function(arg,data)  linkgp = devalsh:get(DEVRMBO.."link:group"..idch)  
...
rem_group('-100'..data.channel_.id_)   
devalsh:sadd(DEVRMBO..'botgps','-100'..data.channel_.id_) 
elseif data.channel_.status_.ID == "ChatMemberStatusEditor" then   
local ramich = '-100'..data.channel_.id_
if devalsh:sismember(DEVRMBO..'bot:gpsby:id:add','-100'..data.channel_.id_)  then  
print('\27[30;33m»» THE GROUP IS HAS BEEN ADD ↓\n»» '..'-100'..data.channel_.id_..'\n\27[1;37m')
else 
print('\27[30;35m»» THE BOT IS ADMIEN AND ADD GROUP ↓\n»» '..'-100'..data.channel_.id_..'\n\27[1;37m')
add_group('-100'..data.channel_.id_)   
devalsh:sadd(DEVRMBO..'bot:gpsby:id','-100'..data.channel_.id_)   
devalsh:sadd(DEVRMBO.."botgps",'-100'..data.channel_.id_)  
devalsh:sadd(DEVRMBO.."bot:gpsby:id:add",'-100'..data.channel_.id_)  
devalsh:set(DEVRMBO.."test:group"..'-100'..data.channel_.id_,'alsh')    
devalsh:set(DEVRMBO.."add:bot:group"..'-100'..data.channel_.id_, true)   
end
return false 
end  
end
...
devalsh:srem(DEVRMBO.."bot:gpsby:id:add",msg.chat_id_)  
devalsh:srem(DEVRMBO.."botgps",msg.chat_id_)  
devalsh:srem(DEVRMBO..'bot:gpsby:id',msg.chat_id_)   
return false
end
...
delete_msg(msg.chat_id_, {[0] = msg.id_}) 
alsh_sendMsg(msg.chat_id_, msg.id_, 1, '',1, 'md')  
end
if msg.sender_user_id_ and is_gban(msg.chat_id_,msg.sender_user_id_) then 
kick(msg,msg.chat_id_,msg.sender_user_id_) 
delete_msg(msg.chat_id_, {[0] = msg.id_}) 
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,msg.sender_user_id_) end
return false 
end
...
kick(msg,msg.chat_id_,msg.content_.members_[0].id_) 
delete_msg(msg.chat_id_, {[0] = msg.id_})  
local list = devalsh:smembers(DEVRMBO..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,msg.content_.members_[0].id_) end
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'del'  and not is_vipgroup(msg) then  
...
if msg.content_.ID == "MessageChatDeleteMember" and devalsh:get(DEVRMBO..'lock:tagservrbot'..msg.chat_id_) then
delete_msg(msg.chat_id_,{[0] = msg.id_}) 
end 
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'ked' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
devalsh:sadd(DEVRMBO..'tedmembars'..msg.chat_id_,msg.sender_user_id_)
end  
...
local mem_id = msg.content_.members_  
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and devalsh:get(DEVRMBO.."lock:Bot:kick"..msg.chat_id_) == 'kick' and not is_vipgroup(msg) then  
kick(msg,msg.chat_id_,mem_id[i].id_)
...
alshadd(data.message_,data)   
alsh(data.message_,data)   
...
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
...
if txxt:find("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]/") and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Pp][Ee]") and devalsh:get(DEVRMBO..'lock:links'..msg.chat_id_) then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]/") and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Tt].[Mm][Ee]/") and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find("[Ww][Ww][Ww].") and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find(".[Cc][Oo][Mm]") then
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) and devalsh:get(DEVRMBO.."lock:Link"..msg.chat_id_) == "del" then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end    
if txxt:find('@[%a%d_]+') and devalsh:get(DEVRMBO.."lock:user:name"..msg.chat_id_) == "del" then
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('@(.+)') and devalsh:get(DEVRMBO.."lock:user:name"..msg.chat_id_) == "del" then
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#[%a%d_]+') and devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "del" then
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
if txxt:find('#(.+)') and devalsh:get(DEVRMBO.."lock:hashtak"..msg.chat_id_) == "del" then
if devalsh:get(DEVRMBO..'lock:edit'..data.chat_id_) then 
delete_msg(data.chat_id_,{[0] = data.message_id_}) 
end    
end
...
devalsh:set(DEVRMBO..'group:name'..v,data.title_)
